...
const PriceComparison = ({ scrollRef: ref }: Props) => {
  return (
    <Frame aria-labelledby="compare-title">
      <div className="flex grow w-full flex-col items-center justify-center gap-8 pt-6 lg:flex-row-reverse lg:gap-16 lg:px-10">
